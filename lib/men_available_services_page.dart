...
class MenAvailableServicesPage extends StatefulWidget {
  const MenAvailableServicesPage({super.key});

  @override
  State<MenAvailableServicesPage> createState() => _MenAvailableServicesPageState();
}

class _MenAvailableServicesPageState extends State<MenAvailableServicesPage> {
